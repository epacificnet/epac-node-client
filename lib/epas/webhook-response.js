...
const logger = { debug: require('debug')('epas:epas-node')};
const {validateVerb, specs } = require('@epas/verb-specifications');
...
class WebhookResponse {
   ...
   * @returns function
   */
  static verifyepasSignature(secret) {
    return (req, res, next) => {
      const header = req.get('epas-Signature');
